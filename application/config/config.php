...
|
*/
$config['base_url'] = 'http'.(isset($_SERVER['HTTPS'])?'s':'').'://'.$_SERVER['HTTP_HOST']. '/insta';
...
$config['sess_cookie_name'] = 'ini_cookie_namanya';
...
$config['csrf_cookie_name'] = 'authenticity_cookie';
